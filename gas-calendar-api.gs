...
function getShopConfig() {
  ...
  const config = {
    ...
    plans: [
      ...
      { name: '成人式プラン',  price: 0,   isEstimate: true,  badge: 'SEIJIN-SHIKI',  badgeClass: 'badge-green',
        consultDateLabel: true, ceremony: true,
        ja: { displayName: '成人式プラン',  note: '振袖選定・撮影内容のご相談<br>※ご予約日時は事前打ち合わせの日時です' },
        en: { displayName: 'Coming-of-Age Plan', note: 'Furisode selection & photo session consultation. The booking time is for the consultation.' },
        zh: { displayName: '成人式方案',  note: '振袖選定及攝影內容諮詢。預約日期為事前商討日。' } },
      { name: '成人式前撮りプラン', price: 0, isEstimate: true, badge: 'SEIJIN-PHOTO', badgeClass: 'badge-green',
        consultDateLabel: true, ceremony: true, requireKimonoChoice: true, requireCeremonyPhoto: true,
        ja: { displayName: '成人式前撮りプラン', note: '振袖姿の前撮り撮影<br>※ご予約日時は事前打ち合わせの日時です' },
        en: { displayName: 'Coming-of-Age Photoshoot', note: 'Pre-ceremony furisode photoshoot. The booking time is for the consultation.' },
        zh: { displayName: '成人式前攝方案', note: '振袖前攝影。預約日期為事前商討日。' } },
      { name: '卒業式プラン',  price: 0,   isEstimate: true,  badge: 'SOTSUGYOU-SHIKI', badgeClass: 'badge-green',
        consultDateLabel: true, ceremony: true,
        ja: { displayName: '卒業式プラン',  note: '袴選定・撮影内容のご相談<br>※ご予約日時は事前打ち合わせの日時です' },
        en: { displayName: 'Graduation Plan', note: "Hakama selection & photo session consultation. The booking time is for the consultation." },
        zh: { displayName: '畢業式方案',  note: '袴選定及攝影內容諮詢。預約日期為事前商討日。' } },
    ...
    options: [
      ...
      // ── 成人式・成人式前撮り 専用オプション ─────────────────────
      // 振袖選択（必須・成人式前撮りプランのみ必須／成人式プランは任意）
      { name: '振袖レンタル',           note: '¥55,000〜・事前打ち合わせ後にお見積もり', price: 55000, unit: '〜', qtyUnit: '名', maxQty: 1,
        forPlans: ['成人式プラン', '成人式前撮りプラン'], kimonoChoice: true, estimatePrice: true,
        en: { name: 'Furisode Rental',      note: 'From ¥55,000 — final price after consultation' },
        zh: { name: '振袖租賃',              note: '¥55,000〜 商討後決定最終價格' } },
      { name: '振袖持ち込み着付け',     note: 'お持ち込みの振袖の着付け代', price: 15400, unit: '/名', qtyUnit: '名', maxQty: 1,
        forPlans: ['成人式プラン', '成人式前撮りプラン'], kimonoChoice: true,
        en: { name: 'Furisode Dressing (Bring Your Own)', note: 'Dressing fee for customer-supplied furisode' },
        zh: { name: '振袖著裝（自備）',     note: '自備振袖之著裝費用' } },
      // 撮影内容（必須・成人式前撮りプランのみ必須／成人式プランは任意）
      { name: 'スタジオ撮影（成人式・卒業式）',         note: '', price: 11000, unit: '/回', qtyUnit: '回', maxQty: 1,
        forPlans: ['成人式プラン', '成人式前撮りプラン', '卒業式プラン'], ceremonyPhotoChoice: true,
        en: { name: 'Studio Photo (Ceremony)' },
        zh: { name: '攝影工作室（典禮）' } },
      { name: 'ロケーション撮影 ブロンズ（成人式・卒業式）', note: '50カット', price: 22000, unit: '/回', qtyUnit: '回', maxQty: 1,
        forPlans: ['成人式プラン', '成人式前撮りプラン', '卒業式プラン'], ceremonyPhotoChoice: true,
        en: { name: 'Location Photo Bronze (Ceremony)', note: '50 shots' },
        zh: { name: '外景攝影 銅牌（典禮）', note: '50張' } },
      { name: 'ロケーション撮影 シルバー（成人式・卒業式）', note: '100カット', price: 33000, unit: '/回', qtyUnit: '回', maxQty: 1,
        forPlans: ['成人式プラン', '成人式前撮りプラン', '卒業式プラン'], ceremonyPhotoChoice: true,
        en: { name: 'Location Photo Silver (Ceremony)', note: '100 shots' },
        zh: { name: '外景攝影 銀牌（典禮）', note: '100張' } },
      { name: 'ロケーション撮影 ゴールド（成人式・卒業式）', note: '150カット', price: 55000, unit: '/回', qtyUnit: '回', maxQty: 1,
        forPlans: ['成人式プラン', '成人式前撮りプラン', '卒業式プラン'], ceremonyPhotoChoice: true,
        en: { name: 'Location Photo Gold (Ceremony)', note: '150 shots' },
        zh: { name: '外景攝影 金牌（典禮）', note: '150張' } },
      // ヘアメイク（成人式系）
      { name: '成人式ヘアセット',       note: '髪飾り含む', price: 5500, unit: '/名', qtyUnit: '名',
        forPlans: ['成人式プラン', '成人式前撮りプラン'],
        en: { name: 'Coming-of-Age Hair Set', note: 'Hair accessories included' },
        zh: { name: '成人式髮型',     note: '含髮飾' } },
      { name: '成人式フルメイク',       note: '', price: 5500, unit: '/名', qtyUnit: '名',
        forPlans: ['成人式プラン', '成人式前撮りプラン'],
        en: { name: 'Coming-of-Age Full Makeup' },
        zh: { name: '成人式彩妝' } },

      // ── 卒業式 専用オプション ─────────────────────
      // 袴選択（必須選択ラジオ）
      { name: '袴レンタル',             note: '振袖・着物・袴のセット', price: 22880, unit: '/名', qtyUnit: '名', maxQty: 1,
        forPlans: ['卒業式プラン'], kimonoChoice: true,
        en: { name: 'Hakama Rental', note: 'Set: kimono + hakama' },
        zh: { name: '袴租賃',           note: '套組：和服+袴' } },
      { name: '袴持ち込み着付け',       note: 'お持ち込みの袴の着付け代', price: 15400, unit: '/名', qtyUnit: '名', maxQty: 1,
        forPlans: ['卒業式プラン'], kimonoChoice: true,
        en: { name: 'Hakama Dressing (Bring Your Own)', note: 'Dressing fee for customer-supplied hakama' },
        zh: { name: '袴著裝（自備）',   note: '自備袴之著裝費用' } },
      // ヘアメイク（卒業式）
      { name: '卒業式ヘアセット',       note: '髪飾り含む', price: 5500, unit: '/名', qtyUnit: '名',
        forPlans: ['卒業式プラン'],
        en: { name: 'Graduation Hair Set', note: 'Hair accessories included' },
        zh: { name: '畢業式髮型',     note: '含髮飾' } },
      { name: '卒業式フルメイク',       note: '', price: 5500, unit: '/名', qtyUnit: '名',
        forPlans: ['卒業式プラン'],
        en: { name: 'Graduation Full Makeup' },
        zh: { name: '畢業式彩妝' } },
    ],
